...
> ⚠ **본 문서는 2026-05-22 시점 스냅샷입니다.** 이후 데이터 안전망(진행 중 복사·종료 후 자동 상세·백업 추적 뱃지) · 휴지통 2단계+미리보기 · 시계 점프 충돌 방어 · Vitest 도입 등이 반영되었으니 현재 동작은 `README.md` · `PRD.md` · `.cursorrules`를 우선 참고하세요. 회차별 변화는 `docs/CHANGELOG.md`에서 시간순으로 볼 수 있습니다.
