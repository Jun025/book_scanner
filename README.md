...
- **휴지통(2단계 삭제)** — "삭제"는 즉시 영구 삭제가 아니라 **휴지통으로 이동**(소프트 삭제). 지난 점검 목록 하단의 **"휴지통 (N) →"** 진입점에서 보관 중인 점검 기록을 보고, 항목별 **[복구]** 또는 **[영구 삭제]** 중 하나를 골라야 영구 삭제가 일어난다. 본문은 휴지통에 있는 동안 그대로 보존되어 실수로 삭제해도 되돌릴 수 있다.
